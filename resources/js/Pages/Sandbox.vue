...
let buttonMessage = ref('Submit Answer');

function checkAnswer() {
    if (buttonMessage.value === 'Next Question') {
    ...
    if (selected.value) {
        ...
        buttonMessage.value = 'Next Question'
    } else {
...
<template>
    ...
    <div class="answer-container lg:basis-2/5">
        ...
        <button class="w-full rounded-lg bg-accent-purple h-16 p-4 text-center text-white" @click="checkAnswer()">
            {{ buttonMessage }}
        </button>
